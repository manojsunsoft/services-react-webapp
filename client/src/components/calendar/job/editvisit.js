...
class Editvisit extends Component {
  ...
  handleCheckChieldElement2 = (event) => {
    ...
    if (id == "schedule_later") {
      ...
      if (data.to_do_all_day.isChecked === true) {
        data.start_time = "";
        data.end_time = "";
      }
    }

    if (id == "to_do_all_day" && data[id].isChecked === true) {
      data.start_time = "";
      data.end_time = "";
    } else if (id == "to_do_all_day" && data[id].isChecked === false) {
      data.start_time = new Date().getHours() + ":" + new Date().getMinutes();
  ...
  componentDidMount() {
    const completed = {
      event_type_id: this.props.visit.id,
      user_id: localStorage.getItem("jwt_servis"),
      event_type: "visit",
    };
    axios
    ...
    console.log(visit);
    if (visit.teamnameid != "") {
      var teamnameid = visit.teamnameid;
      this.setState({
        TeamOneMemberChecked: true,
      });
    } else {
      var teamnameid = [];
    }
    ...
    this.setState({
      ...
      products: visit.products ? visit.products : [],
  ...
  onSubmit = (event) => {
    ...
    axios
      .post(localStorage.Baseurl + "/wp-json/jobs/v2/update_one_visit", {
        jobs,
      })
      .then((res) => {
        const jobs = res.data;
            ...
            <div className="row row--tightColumns">
              ...
              <div className="small-12 medium-expand small-order-3 medium-order-2 columns">
                <div className="row row--tightColumns align-middle">
                  ...
                  {/* .columns */}
                  <div className="small-11 medium-4 columns">
                    <div className="table-data" data-label="Visit Cost (₹">
                      <placeholder-field
                        label
                        className="placeholderField--small u-marginBottomNone placeholderField--noMiniLabel placeholderField is-filled"
                        auto-size="false"
                          ...
                          <div className="card-headerActions">
                            <div className="checkbox u-marginBottomSmallest">
                              <input
                                ...
                                checked={this.state.schedule_later.isChecked}
                                ...
                                <div className="columns">
                                  ...
                                  <div
                                    className={
                                      ...
                                      (this.state.schedule_later.isChecked ===
                                      true
                                        ? " is-disabled"
                                        : "")
                                    }
                                  >
                                    <input
                                      ...
                                      type="checkbox"
                                      checked={
                                        this.state.to_do_all_day.isChecked
                                      }
                                      name="to_do_all_day"
                                      id="to_do_all_day"
                                      onChange={this.handleCheckChieldElement2}
