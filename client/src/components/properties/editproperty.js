...
class Editpropertyform extends Component {
  ...
  handleSubmit = (event) => {
    ...
    Geocode.fromAddress(address).then((response) => {
      ...
      axios
        .post(
          localStorage.Baseurl + "/wp-json/properties/v2/update_one_property",
          { property }
        )
        .then((res) => {
  ...
  componentDidMount() {
    const { properyID } = this.props.ProperyID;
    const user = {
      properyID: properyID,
      user_id: localStorage.getItem("jwt_servis"),
    };
  ...
  onDelete = (event, dataid) => {
    this.setState({ onDeletePop: true, property_id: dataid });
  };

  DeleteData = (data, action) => {
    if (action && action == "deleted") {
      this.props.getData(data, action);
    } else {
  ...
  render() {
    const property_id = this.state.property_id;
    const people_id = this.state.people_id;
    console.log(property_id);
    let prefix;
    prefix = this.props.Prifix;
    var property_street1 = prefix + "property_street1";
    var property_street2 = prefix + "property_street2";
    var property_city = prefix + "property_city";
    var property_province = prefix + "property_province";
    var property_country = prefix + "property_country";
    var property_pc = prefix + "property_pc";
            ...
            <div className={this.props.classes ? "" : "card card--paddingNone"}>
                ...
                >
                  ...
                  >
                      ...
                      <div className="fieldGroup js-erbPropertyForm">
                        <div className="row collapse">
                          <div className="columns">
                            ...
                            >
                              <label
                                htmlFor={prefix + "property_street1"}
                                data-label="Street 1"
                                className={
                              ...
                              <input
                                ...
                                name={prefix + "property_street1"}
                                id={prefix + "property_street1"}
                        ...
                        <div className="row collapse">
                          <div className="columns">
                            ...
                            >
                              <label
                                htmlFor={prefix + "property_street2"}
                                data-label="Street 2"
                                className={
                                  "placeholderField-label " +
                                  (this.state[property_street2]
                              ...
                              <input
                                ...
                                type="text"
                                name={prefix + "property_street2"}
                                onChange={this.handleChange}
                                id={prefix + "property_street2"}
                        ...
                        <div className="row collapse">
                          ...
                          <div className="columns">
                            ...
                            >
                              <label
                                htmlFor={prefix + "property_province"}
                                data-label="State"
                                className={
                                  "placeholderField-label " +
                                  (this.state[property_province]
                              ...
                              <input
                                ...
                                type="text"
                                name={prefix + "property_province"}
                                onChange={this.handleChange}
                                id={prefix + "property_province"}
                          ...
                          <div className="columns">
                            ...
                            >
                              ...
                              <input
                                ...
                                type="text"
                                name={prefix + "property_pc"}
                                onChange={this.handleChange}
                                id={prefix + "property_pc"}
                    ...
                    <CustomFields
                      applied_to="property"
                      ref="fields"
                      form_id={this.props.ProperyID.properyID}
                      update="edit"
                    />
                  </form>
                </div>
              ...
              <div className="row align-middle u-borderTop u-paddingTopSmall u-paddingBottomSmall">
                ...
                <div
                  ...
                  onClick={(event) => this.onDelete(event, property_id)}
                >
                  <div
