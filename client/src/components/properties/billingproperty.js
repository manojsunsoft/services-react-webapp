...
class Billingpropertyform extends Component {
  constructor() {
    super();
    this.state = {
      billing_property_street1: "",
      billing_property_street2: "",
      billing_property_city: "",
      billing_property_province: "",
      billing_property_pc: "",
      billing_property_country: "",
    };
  ...
  handleSubmit = (event) => {
    ...
    axios
      .post(localStorage.Baseurl + "/wp-json/properties/v2/add_one_property", {
        property,
      })
      .then((res) => {
  ...
  componentDidMount() {
    const user = this.props.peopleID;
    axios
    ...
    axios
      ...
      .then((res) => {
        ...
        this.setState({
          adrs_id: property.adrs_id,
          billing_property_street1: property.billing_property_street1,
          billing_property_street2: property.billing_property_street2,
          billing_property_city: property.billing_property_city,
          billing_property_province: property.billing_property_province,
          billing_property_pc: property.billing_property_pc,
          billing_property_country: property.billing_property_country,
        });
        this.props.getPropData2(this.state);
      });
  }
              ...
              <div className={this.props.classes ? "" : "row"}>
                ...
                >
                  ...
                  >
                      ...
                      <div className="fieldGroup js-erbPropertyForm">
                        <div className="row collapse">
                          <div className="columns">
                            ...
                            >
                              <label
                                htmlFor={"billing_property_street1"}
                                data-label="Street 1"
                                className={
                              ...
                              <input
                                ...
                                name={"billing_property_street1"}
                                id={"billing_property_street1"}
                                value={this.state.billing_property_street1}
                              />
                            </placeholder-field>
                          </div>
                        </div>
                        <div className="row collapse">
                          <div className="columns">
                            ...
                            >
                              <label
                                htmlFor={"billing_property_street2"}
                                data-label="Street 2"
                                className={
                                  "placeholderField-label " +
                                  (this.state.billing_property_street2
                                    ? "is-hidden"
                                    : "")
                                }
                              >
                              ...
                              <input
                                ...
                                type="text"
                                name={"billing_property_street2"}
                                onChange={this.handleChange}
                                id={"billing_property_street2"}
                                value={this.state.billing_property_street2}
                              />
                            </placeholder-field>
                          </div>
                        </div>
                          ...
                          <div className="columns">
                            ...
                            >
                              ...
                              <input
                                ...
                                type="text"
                                name={"billing_property_city"}
                                onChange={this.handleChange}
                                id={"billing_property_city"}
                                value={this.state.billing_property_city}
                              />
                            </placeholder-field>
                          </div>
                          <div className="columns">
                            ...
                            >
                              <label
                                htmlFor={"billing_property_province"}
                                data-label="State"
                                className={
                                  "placeholderField-label " +
                              ...
                              <input
                                ...
                                type="text"
                                name={"billing_property_province"}
                                onChange={this.handleChange}
                                id={"billing_property_province"}
                                value={this.state.billing_property_province}
                              />
                            </placeholder-field>
                          </div>
                        </div>
                          ...
                          <div className="columns">
                            ...
                            >
                              ...
                              <input
                                ...
                                type="text"
                                name={"billing_property_pc"}
                                onChange={this.handleChange}
                                id={"billing_property_pc"}
                                value={this.state.billing_property_pc}
                              />
                            </placeholder-field>
                          </div>
                          <div className="columns">
                            <div className="select fieldGroup-field">
                              <select
                                ...
                                select_className="fieldGroup-field"
                                className="large country"
                                data-mini="true"
                                data-country-select="true"
                                name={"billing_property_country"}
                                onChange={this.handleChange}
                                id={"billing_property_country"}
                              >
                    ...
                    <div className="customFieldForm js-customFieldListForProperty"></div>
                  </form>
                </div>
              </div>
...
export default Billingpropertyform;
