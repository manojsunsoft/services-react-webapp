...
class Editvisit extends Component {
  ...
  handleCheckChieldElement2 = (event) => {
    ...
    if (id == "schedule_later") {
      ...
      if (data.all_day.isChecked === true) {
        data.start_time = "";
        data.end_time = "";
      }
    }

    if (id == "all_day" && data[id].isChecked === true) {
      data.start_time = "";
      data.end_time = "";
    } else if (id == "all_day" && data[id].isChecked === false) {
      data.start_time = new Date().getHours() + ":" + new Date().getMinutes();
  ...
  componentDidMount() {
    ...
    this.setState({
      ...
      product: visit.products ? visit.products : [],
      team_reminder: visit.team_reminder,
      ...
      count: visit.products.length - 1,
      created_at: visit.created_at,
      schedule_later: visit.schedule_later,
                                ...
                                <div className="columns">
                                  ...
                                  >
                                    <input
                                      ...
                                      type="checkbox"
                                      checked={this.state.all_day.isChecked}
                                      name="all_day"
                                      id="all_day"
                                      onChange={this.handleCheckChieldElement2}
                                    />
