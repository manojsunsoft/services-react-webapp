...
class Editpayment extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .post(localStorage.Baseurl + "/wp-json/invoice/v2/get_one_payment", {
        invoice,
      })
      .then((res) => {
        const data = res.data;
  ...
  onSubmit = (event) => {
    ...
    axios
      .post(localStorage.Baseurl + "/wp-json/invoice/v2/update_one_payment", {
        invoice,
      })
      .then((res) => {
        const id = res.data;
  ...
  deletepayments = (event) => {
    ...
    axios
      .post(localStorage.Baseurl + "/wp-json/invoice/v2/delete_one_payment", {
        invoice,
      })
      .then((res) => {
        const id = res.data;
      ...
      <div className="dialog-overlay js-dialog-overlay draggable">
        <div className="dialog-box dialog-box--small ui-draggable">
          <div className="dialog-header dialog-header--bgFill ui-draggable-handle">
            <div className="dialog-title js-dialogTitle">Payment</div>
            <sg-icon
                        ...
                        <div className="dialog-box dialog-box--small ui-draggable">
                          ...
                          <div className="dialog-content">
                            ...
                            >
                              ...
                              from the billing history for Nathaniel Lewis
                            </p>
