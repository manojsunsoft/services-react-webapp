...
class EditFields extends Component {
  ...
  componentDidMount() {
    this.setState({
      id: this.props.applied[0].id,
      applied_to: this.props.applied[0].applied_to,
      custom_field_name: this.props.applied[0].custom_field_name,
      default_value_bool: this.props.applied[0].custom_field_value,
      default_value_int: this.props.applied[0].custom_field_value,
      default_value_text: this.props.applied[0].custom_field_value,
      custom_field_type: this.props.applied[0].field_type,
      default_area_value_1: this.props.applied[0].custom_field_value
        .default_area_value_1
        ? this.props.applied[0].custom_field_value.default_area_value_1
        : "",
      default_area_value_2: this.props.applied[0].custom_field_value
        .default_area_value_1
        ? this.props.applied[0].custom_field_value.default_area_value_2
        : "",
      options: this.props.applied[0].custom_field_value.options
        ? this.props.applied[0].custom_field_value.options
        : [{ option: "" }],
      count: this.props.applied[0].custom_field_value.options
        ? this.props.applied[0].custom_field_value.options.length - 1
        : this.state.count,
    });
  }
  ...
  handleSubmit = (event) => {
    ...
    axios
      .post(localStorage.Baseurl + "/wp-json/settings/v2/edit_custom_fields", {
        field,
      })
      .then((res) => {
  ...
  handleDelete = (event) => {
    ...
    axios
      .post(
        localStorage.Baseurl + "/wp-json/settings/v2/delete_custom_fields",
        {
          field,
        }
      )
        ...
        <div className="dialog-box ui-draggable" bis_skin_checked={1}>
          ...
          >
            <div className="u-paddingSmall" bis_skin_checked={1}>
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    className="placeholderField-input"
                    onChange={this.handleChange}
                    value={this.state.custom_field_name}
                  />
                </placeholder-field>
                ...
                <div className="select " bis_skin_checked={1}>
                  <select
                    ...
                    onChange={this.handleChange}
                    value={this.state.custom_field_type}
                    disabled={true}
                  >
                ...
                >
                  ...
                  <div className="select " bis_skin_checked={1}>
                    <select
                      ...
                      onChange={this.handleChange}
                      value={this.state.default_value_bool}
                    >
                      ...
                      <div className="columns" bis_skin_checked={1}>
                        ...
                        >
                          ...
                          <input
                            ...
                            className="placeholderField-input"
                            onChange={this.handleChange}
                            value={this.state.default_value_int}
                          />
                        </placeholder-field>
                      </div>
                      {/* .columns */}
                    ...
                    >
                      ...
                      >
                        ...
                        <input
                          ...
                          className="placeholderField-input"
                          value={this.state.default_area_value_1}
                          onChange={this.handleChange}
                        />
                      </placeholder-field>
                    </div>
                    ...
                    <div className="columns" bis_skin_checked={1}>
                      ...
                      >
                        ...
                        <input
                          ...
                          className="placeholderField-input"
                          onChange={this.handleChange}
                          value={this.state.default_area_value_2}
                        />
                      </placeholder-field>
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={this.handleChange}
                      value={this.state.default_value_text}
                    />
                  </placeholder-field>
                </div>
                ...
                <div className="dialog-actions " bis_skin_checked={1}>
                  <div className="flexBlock" bis_skin_checked={1}>
                    <a
              ...
              {this.state.openDeletePop && (
                <div
                  className="dialog-overlay js-dialog-overlay draggable"
                  bis_skin_checked={1}
                >
                  <div
                    className="dialog-box dialog-box--small js-customFieldDestroyDialog ui-draggable"
                    bis_skin_checked={1}
                  >
                    <div
                      className="dialog-header dialog-header--bgFill ui-draggable-handle"
                    ...
                    >
                      <div
                        ...
                        bis_skin_checked={1}
                      >
                        Confirm Custom Field Deletion
                      </div>
                      <sg-icon className="js-closeDialog icon" icon="cross" />
                    </div>
                    <div className="dialog-content" bis_skin_checked={1}>
                      <div
                        ...
                        bis_skin_checked={1}
                      >
                        Please confirm your deletion request by checking the
                        boxes below.
                      </div>
                      <p className="u-marginBottomSmall paragraph">
                        Are you absolutely sure you want to delete this Custom
                        Field?
                      </p>
                      <div className="u-borderBottom" bis_skin_checked={1} />
                      <form acceptCharset="UTF-8">
                        <div className="dialog-actions" bis_skin_checked={1}>
                          <div
                            className="button button--greyBlue button--ghost js-closeDialog"
                            onClick={(event) =>
                              this.handleClose(event, "close")
                            }
                            bis_skin_checked={1}
                          >
                            Cancel
                          ...
                          <input
                            ...
                            name="commit"
                            defaultValue="Delete"
                            className="button button--red button--ghost js-spinOnClick remove"
                            id="submit_button"
