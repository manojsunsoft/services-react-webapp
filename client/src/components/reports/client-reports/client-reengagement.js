...
class Client_reengagement extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      >
        ...
        <div className="flexContent  js-injectContent">
          <div id="report" className="columns">
            <h1 className="headingOne">Client Re-engagement</h1>
            <div id="bottom_section">
              <div
                id="table_holder"
                className="u-marginBottom"
                data-sortable="[true,false,false,false,true,false]"
                data-initial-sort-column='[[4,"desc"]]'
              >
                <div
                ...
                >
                  <div className="card card--paddingNone u-clearfix">
                          ...
                          <div className="dropdown js-dropdown">
                            ...
                            <div className="dropdown-menu js-dropdownMenu">
                              <div className="dropdown-section">
                                <a
                                  href="https://secure.getjobber.com/reports/client_reengagement.csv?iSortCol_0=4&sSortDir_0=desc&include_all_columns=true"
                                  className="dropdown-item js-csvDownloadAll"
                                >
                                  All columns
                                </a>
                                <a
                                  href="https://secure.getjobber.com/reports/client_reengagement.csv?iSortCol_0=4&sSortDir_0=desc&hidden_columns=&include_all_columns=false"
                    ...
                    <div className="card-content u-borderBottom">
                      <table
                        data-source="/reports/client_reengagement.json"
                        width="100%"
                        ...
                        <thead>
                          <tr role="row">
                            ...
                            <td
                              ...
                              rowSpan={1}
                              colSpan={1}
                              aria-label="Last Job Closed On: activate to sort column ascending"
                              style={{ width: 302 }}
                            >
                              Last Job Closed On
                            </td>
...
export default Client_reengagement;
