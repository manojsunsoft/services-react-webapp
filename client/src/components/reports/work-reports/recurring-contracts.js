...
class Recurring_contracts extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      >
        ...
        <div className="flexContent  js-injectContent">
          <div id="report" className="columns">
            <h1 className="headingOne">Recurring Jobs Report</h1>
            <div id="summary">
                    ...
                    <ul className="list list--dividers">
                      <li className="list-item">
                        <a
                          ...
                          href="/reports/recurring_contracts/active"
                        >
                      ...
                      <li className="list-item">
                        <a
                          className="list-itemLink u-colorGreyBlueDark"
                          href="/reports/recurring_contracts/completed"
                        >
                          <div className="row row--tightColumns align-middle">
                            <div className="small-2 columns">
                      ...
                      <li className="list-item">
                        <a
                          ...
                          href="/reports/recurring_contracts"
                        >
                          <div className="row row--tightColumns align-middle">
                            <div className="small-2 columns">
                  ...
                  <div className="card u-marginBottom js-reportOptions">
                    ...
                    >
                      ...
                      <input
                        ...
                        defaultValue="jFyVlGwVYPc4kMg3CRSXwmSS83aWuniqger5uLsScd27OxRwo4gLp1OPFIFARethW/ehISgRDgKgvAp9/0vKWw=="
                      />
            ...
            <div id="bottom_section">
              <div
                ...
                data-sortable="[true,true,true,true,true,true,false,true,false,false,true,false,false,false,false]"
                data-extra-params='{"subsection":"","hidden_columns":[5,7,9,10,12,13],"right_align_columns":[6,10,11]}'
              >
                <div
                ...
                >
                  <div className="card card--paddingNone u-clearfix">
                    <div className="card-header card-header--bgFill u-marginBottomNone">
                      <div className="row row--fullWidth collapse align-justify">
                        ...
                        <div className="columns collapse shrink">
                          <div className="dropdown js-dropdown">
                            ...
                            <div className="dropdown-menu js-dropdownMenu">
                              <div className="dropdown-section">
                                <a
                                  href="https://secure.getjobber.com/reports/recurring_contracts.csv?iSortCol_0=0&sSortDir_0=asc&subsection=&include_all_columns=true"
                                  className="dropdown-item js-csvDownloadAll"
                                >
                                  All columns
                                </a>
                                <a
                                  href="https://secure.getjobber.com/reports/recurring_contracts.csv?iSortCol_0=0&sSortDir_0=asc&subsection=&hidden_columns=5%2C7%2C9%2C10%2C12%2C13&include_all_columns=false"
                          ...
                          >
                            <span className="js-columnCount">9/15</span>
                            &nbsp;Columns
                            <sg-icon
                              className="icon--onRight icon"
                              icon="arrowDown"
                    ...
                    <div className="card-content u-borderBottom">
                      <table
                        data-source="/reports/recurring_contracts.json"
                        width="100%"
                        ...
                        <thead>
                          <tr role="row">
                            ...
                            <td
                              ...
                              rowSpan={1}
                              colSpan={1}
                              aria-label="Job end: activate to sort column ascending"
                              style={{ width: 56 }}
                            >
                              Job end
                            </td>
...
export default Recurring_contracts;
