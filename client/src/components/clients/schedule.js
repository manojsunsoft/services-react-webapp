...
class Schedule extends Component {
  ...
  getDatacal = () => {
    ...
    this.setState({ loading: true });
    axios
      .post(localStorage.Baseurl + "/wp-json/peoples/v2/get_people_schedules", {
        client,
      })
      .then((res) => {
        ...
        <div className="card-header card-header--bgFill u-marginBottomNone u-borderBottomNone">
          ...
          <div className="dropdown js-dropdown">
            ...
            >
              <nav>
                <Link
                  class="dropdown-item js-dropdownItem"
                  to={{
                ...
                >
                  <sg-icon icon="request" class="icon"></sg-icon>Request
                </Link>
                <Link
                      ...
                      {visits[key1][key2].map((visit, key3) => (
                        ...
                        >
                          <div className="row collapse">
                            ...
                            >
                              <a className="row row--tightColumns js-spinOnClick js-toDoDialogBoxLink">
