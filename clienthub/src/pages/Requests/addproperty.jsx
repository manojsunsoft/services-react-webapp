              ...
              >
                <label
                  ...
                  className={
                    ...
                    (this.state.property_street1 ? "is-hidden" : "")
                  }
                >
                  Street 1
                </label>
                {
                  <Autocomplete
                    onPlaceSelected={(place) => this.getAdress(place)}
                    id={"property_street1"}
            ...
            <div className="columns">
              ...
              >
                <label
                  ...
                  className={
                    "placeholderField-label " +
                    (this.state.property_street2 ? "is-hidden" : "")
                  }
                >
                  Street 2
                </label>
            ...
            <div className="columns">
              ...
              >
                <label
                  ...
                  className={
                    "placeholderField-label " +
                    (this.state.property_province ? "is-hidden" : "")
                  }
                >
                  State
                </label>
